...
public class DatabaseConfiguration {
    ...
    public DataSource druidDataSource() {
       ...
       /* druidDataSource.setUrl("jdbc:mysql://rm-uf61rioh6u9015vz38o.mysql.rds.aliyuncs.com:3306/db_healthy?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&failOverReadOnly=false&autoReconnect=true&roundRobinLoadBalance=true");
        druidDataSource.setUsername("zqkhlive");
        druidDataSource.setPassword("Zqkh2018!@#321");*/
        try {
